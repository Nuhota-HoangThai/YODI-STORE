<template>
  ...
  >
    <div class="container py-4 px-32 mx-auto" v-if="products.length > 0">
      <!-- Product -->
      <span class="text-xl font-bold uppercase">{{ searchText }}</span>
    ...
    <div class="my-8" v-else>
      <h1 class="text-center text-2xl">Không có sản phẩm!!</h1>
    </div>
  </div>
</template>
